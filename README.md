...
<div>
    ...
    <img src="[https://media.giphy.com/media/xT0xeJpnkO3jXHwhYg/giphy.gif](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZ3B6MGRlMzhrYnRlNGh0c2FtenpoM2p4bW5udndkYmR2Z2Y1cW1sZiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/qgQUggAC3Pfv687qPC/giphy.gif)" alt="About Me GIF"/>
</div>
...
- 🔍 **Learning AI Engineering**: Exploring **data parallelism**, optimizing **deep learning models** for performance across multiple GPUs, and working with cutting-edge techniques in **machine vision** and **NLP**.
- 📊 **Building Full-Stack Applications**: Developing end-to-end applications that can integrate AI-powered features like recommendation engines, predictive analytics, and more.
